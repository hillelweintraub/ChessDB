...
var ImagePathOld="-", ImagePath="../static/pgnviewer/img/merida33/", ImageOffset=0, IsLabelVisible=true, Border=1, BorderColor="#404040", ScoreSheet=0, BGColor="";
...
{ var ii, ffrom="", ccapt=0, ll, yy1i=-1;
  ...
  { if ((mm.indexOf("O")>=0)||(mm.indexOf("0")>=0))
    { if ((mm.indexOf("O-O-O")>=0)||(mm.indexOf("0-0-0")>=0)||(mm.indexOf("O\96O\96O")>=0)||(mm.indexOf("0??")>=0)) 
      { if (EvalMove(ttype0, 6, xx0, yy0, ttype1, xx1, yy1, ccapt, sstore))
          return(1);
        return(0);
      }
      if ((mm.indexOf("O-O")>=0)||(mm.indexOf("0-0")>=0)||(mm.indexOf("O\96O")>=0)||(mm.indexOf("0?")>=0))
    ...
    if ((mm.indexOf("---")>=0)||(mm.indexOf("\96\96?")>=0))
